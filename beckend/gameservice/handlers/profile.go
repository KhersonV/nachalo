...
type playerProfileResponse struct {
	...
	BaseStats        *repository.EquipmentStats   `json:"baseStats,omitempty"`
	EquipmentBonuses *repository.EquipmentBonuses `json:"equipmentBonuses,omitempty"`
}
...
func loadProfileData(userID int) (*profileDataResponse, error) {
	...
	baseStats := repository.EquipmentStats{
	...
	equipmentBonuses := repository.EquipmentBonuses{}
	if player.SelectedCharacterID != nil {
		effectiveStats, err := repository.GetCharacterEffectiveStats(*player.SelectedCharacterID)
		if err != nil {
			return nil, err
		}
		baseStats = effectiveStats.BaseStats
		equipmentBonuses = equipmentBonusFromStats(effectiveStats.BaseStats, effectiveStats.EffectiveStats)
		player.MaxHealth = effectiveStats.EffectiveStats.MaxHealth
		player.Health = effectiveStats.EffectiveStats.MaxHealth
		player.MaxEnergy = effectiveStats.EffectiveStats.MaxEnergy
		player.Energy = effectiveStats.EffectiveStats.MaxEnergy
		player.Attack = effectiveStats.EffectiveStats.Attack
		player.Defense = effectiveStats.EffectiveStats.Defense
		player.Mobility = effectiveStats.EffectiveStats.Mobility
		player.Agility = effectiveStats.EffectiveStats.Agility
		player.SightRange = effectiveStats.EffectiveStats.SightRange
		player.IsRanged = effectiveStats.EffectiveStats.IsRanged
		player.AttackRange = effectiveStats.EffectiveStats.AttackRange
	}
