    ...
    try {
      ...
      dispatch({
        ...
        payload: {
          ...
          questArtifactId: data.quest_artifact_id ?? 0,
          questArtifactName: data.quest_artifact_name ?? "",
          questArtifactImage: data.quest_artifact_image ?? "",
          questArtifactDescription: data.quest_artifact_description ?? "",
        },
      });
    } catch (e) {
      console.error("Failed to load match, resources, or monsters", e);
      router.replace("/mode");
    } finally {
